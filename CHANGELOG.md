...
- **CI/CD (GitHub Actions):**
    - Created pipeline `.github/workflows/ci.yaml`.
    - Automated Docker Image building.
    - Integrated with **GitHub Container Registry (GHCR)** for artifact storage.
    - Fixed build context issues to support `src/` structure correctly.

## [0.3.0] - 2026-02-01
### Added
- **Orchestration (Helm):**
    - Created generic Helm Chart (`charts/saas-app`) supporting:
        - Dynamic Environment Variables.
        - Liveness and Readiness Probes.
        - Non-root security context.
    - Verified manual deployment flow: Lint -> Install -> Port-Forward -> Uninstall.
